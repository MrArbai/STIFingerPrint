...
Public Class FrmTrnCutiIzinApproveByPSN : Inherits DockContent
    Private Sub FrmTrnCutiIzinApproveByPSN_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call SetGridDefult()
    ...
    Private Sub SetGridDefult()
        ...
        With fg1
            ...
            txt = .GetCellRange(0, 13, 0, 13) : txt.Data = "Diapprove Oleh" : .Cols(13).Name = "DiapproveOleh" : .Cols(13).Width = 100 : .Cols(13).TextAlign = TextAlignEnum.CenterCenter
            txt = .GetCellRange(0, 14, 0, 14) : txt.Data = "Diapprove Tanggal" : .Cols(14).Name = "DiapproveDate" : .Cols(14).Width = 100 : .Cols(14).TextAlign = TextAlignEnum.CenterCenter
            txt = .GetCellRange(0, 15, 0, 15) : txt.Data = "Komputer" : .Cols(15).Name = "Computer" : .Cols(15).Width = 100 : .Cols(15).TextAlign = TextAlignEnum.CenterCenter
            txt = .GetCellRange(0, 16, 0, 16) : txt.Data = "Komputer Tanggal" : .Cols(16).Name = "ComputerDate" : .Cols(16).Width = 100 : .Cols(16).TextAlign = TextAlignEnum.CenterCenter
    ...
    Private Sub GetDataHeader()
        ...
        sql = "  SELECT DISTINCT HeaderID,StatusTk,Nik,Nama,Departemen,JabatanName,TglAwal,TglAkhir,NamaTidakKerja,Keterangan,CreateBy,CreateDate,Computer,ComputerDate " &
                " ,ApproveByDept,ApproveByDeptDate ,ApproveByPSN,ApproveByPSNDate FROM vwTrnCutiIzin WHERE DeptID ='" & cboDepartemen.SelectedValue & "' and Complete=1 and ApproveByDept is not null and ApproveByPSN is null Order By Nik,TglAwal,TglAkhir "
                ...
                If DR.HasRows Then
                    With fg1
                        While DR.Read
                            ...
                            If IsDBNull(DR!ApproveByDept) = False Then .Item(i, "DiapproveOleh") = DR!ApproveByDept
                            If IsDBNull(DR!ApproveByDeptDate) = False Then .Item(i, "DiapproveDate") = DR!ApproveByDeptDate
    ...
    Private Sub Simpan()
        ...
        Try
            ...
            With CMD
                ...
                If ListHeaderID <> "" Then
                    .CommandText = "Update tblTrnCutiIzinHdr set ApproveByPSN='" & UserLogin & "',ApproveByPSNDate=getdate() where HeaderID in (" & ListHeaderID & ") "
                    .ExecuteNonQuery()
                End If
                If ListHeaderIDDToADM <> "" Then
                    .CommandText = "Update tblTrnCutiIzinHdr set Complete=0,ApproveByDept=null,ApproveByDeptDate=null,ApproveByPSN=null,ApproveByPSNDate=null where HeaderID in (" & ListHeaderIDDToADM & ") "
                    .ExecuteNonQuery()
                End If
            End With
